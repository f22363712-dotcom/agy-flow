...
from agy_flow.connectors import agents_report, probe_all
...
def doctor():
    ...
    cfg_file = agy_flow.config.CONFIG_FILE
        ...
        errors.append(
            {
                "check": "config",
                "status": "error",
                "detail": "Config file not found. Run 'agy-flow init'.",
            }
        )
        ...
        warnings.append(
            {
                "check": "board",
                "status": "warning",
                "detail": "Board file not found. Run 'agy-flow init'.",
            }
        )
